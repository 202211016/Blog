...
//     validateRequest(req: any, res: any, next: any, schema: Joi.ObjectSchema) {
//         // Implement your validation logic here
//         return true;  // Adjust the return value based on your validation result
//     }
// }
export class validations {
    constructor() { }
...
validateIDParam = (req: any, res: any, next: any) => {
    ...
    if (error) {
        let functionsObj = new functions();
        res.send(functionsObj.output(0, error.details[0].message));
        return;
    }
    next();
};
